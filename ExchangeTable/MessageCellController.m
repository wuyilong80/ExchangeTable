//
//  MessageCellController.m
//  ExchangeTable
//
//  Created by user44 on 2017/5/11.
//  Copyright © 2017年 wuyilong. All rights reserved.
//

#import "MessageCellController.h"

@implementation MessageCellController
...
- (void)setSelected:(BOOL)selected animated:(BOOL)animated {
    ...
    self.backgroundColor = [UIColor colorWithRed:0.99 green:0.99 blue:0.99 alpha:0.1];
